  ...
  services.nginx.virtualHosts = {
    ...
    "crypt.${config.link.domain}" = {
      ...
      extraConfig = ''
        ...
        add_header Content-Security-Policy "default-src 'none'; style-src 'unsafe-inline' 'self' https://crypt.alinkbetweennets.de;font-src 'self' data: https://crypt.alinkbetweennets.de; child-src https://crypt.alinkbetweennets.de; frame-src 'self' blob: https://cryptui.alinkbetweennets.de; script-src 'self' resource: https://crypt.alinkbetweennets.de https://cryptui.alinkbetweennets.de; script-src-elem 'self' blob: resource: https://crypt.alinkbetweennets.de 'sha256-ZswfTY7H35rbv8WC7NXBoiC7WNu86vSzCDChNWwZZDM=' 'sha256-Y1z0SyVx5S7ywM8HEuxVVkmBpqUjj6qZLBNBVk8E6h8=' 'sha256-OGjU0xQxuhdJDf8iMcgZXmRJZD2QZBQJRLwrFlOBLkI=' 'sha256-ZswfTY7H35rbv8WC7NXBoiC7WNu86vSzCDChNWwZZDM=' 'sha256-OGjU0xQxuhdJDf8iMcgZXmRJZD2QZBQJRLwrFlOBLkI=';img-src 'self' data: blob: https://crypt.alinkbetweennets.de; worker-src 'self';media-src blob: ; frame-ancestors 'self' https://crypt.alinkbetweennets.de;connect-src 'self' blob: https://crypt.alinkbetweennets.de https://cryptui.alinkbetweennets.de wss://crypt.alinkbetweennets.de; report-uri http://v2202312204123249185.ultrasrv.de:4000; report-to default" always;
      '';
    ...
    "cryptui.${config.link.domain}" = {
      ...
      extraConfig = ''
        ...
        add_header Report-To '{"max_age":31536000,"endpoints":[{"url":"http://v2202312204123249185.ultrasrv.de:4000/csp-report"}]}';
        add_header X-Frame-Options sameorigin;
        add_header Content-Security-Policy "default-src 'none'; style-src 'unsafe-inline' 'self' https://crypt.alinkbetweennets.de;font-src 'self' data: https://crypt.alinkbetweennets.de; child-src https://crypt.alinkbetweennets.de; frame-src 'self' blob: https://cryptui.alinkbetweennets.de; script-src 'self' resource: https://crypt.alinkbetweennets.de ;script-src-elem 'self' resource: https://crypt.alinkbetweennets.de 'sha256-Y1z0SyVx5S7ywM8HEuxVVkmBpqUjj6qZLBNBVk8E6h8=' 'sha256-ZswfTY7H35rbv8WC7NXBoiC7WNu86vSzCDChNWwZZDM=' 'sha256-OGjU0xQxuhdJDf8iMcgZXmRJZD2QZBQJRLwrFlOBLkI=' 'sha256-ZswfTY7H35rbv8WC7NXBoiC7WNu86vSzCDChNWwZZDM=' 'sha256-OGjU0xQxuhdJDf8iMcgZXmRJZD2QZBQJRLwrFlOBLkI=' 'sha256-R5+O+GguAMEaEziO1n5XU7JdxbmNH9PrD0455tGIo+Y=' 'sha256-R/9llE0s4++pxJWFqpVdB+eQJk2ANaxrUkOoEgbf4BE=' 'sha256-+ac8khtNoT0aNZRgSgtufqMcKat1zoMcy2QKOy1king=' 'sha256-OEAthcFABIfn7TlCbTV6bGAv1qO5kVS02Tbru9uBM7E=' 'sha256-550mecyv+58pd1gBLH1QBIOUYSFa6dRGnPr5EQydW1Y=' 'sha256-XqyszejV2KjHp1R/rjEZrlZr+jaJpoSSF34CliTkwsA=' 'sha256-EzOdKxNif8wH7zIpBWq8C8s7ReXFFUgKIeh3S8mbzmg=' 'sha256-fWlVIwe2LsO09S7H48jPEdZpXqvWNASN9MJtP9UqorQ=';img-src 'self' data: blob: https://crypt.alinkbetweennets.de; worker-src 'self';media-src blob: ; frame-ancestors 'self' https://crypt.alinkbetweennets.de;connect-src 'self' blob: https://crypt.alinkbetweennets.de https://cryptui.alinkbetweennets.de wss://crypt.alinkbetweennets.de;report-uri http://v2202312204123249185.ultrasrv.de:4000; report-to default" always;
