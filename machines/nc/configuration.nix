...
{ pkgs, lib, config, flake-self, home-manager, ... }: {
  ...
  networking.nftables = {
    ...
    #       iifname "ens3" ip6 daddr 202.61.251.70 tcp dport 80 dnat to 100.98.35.19:80
    #     }
    #   }
    # '';
  };
  networking.nat = {
    ...
    # externalIP = "100.87.16.37/32";
    internalInterfaces = [ "tailscale0" ];
    # internalIPs = [ "202.61.251.70" ];
    # internalIPv6s = [ "fd7a:115c:a1e0::4f01:1025/128" ];
    forwardPorts = [
      # {
      #   sourcePort = 51820;
      #   proto = "udp";
      #   destination = "10.10.10.63:51820";
      #   loopbackIPs = [ "100.98.35.19" ];
      # }
      # {
      #   sourcePort = 51822;
      #   proto = "udp";
  ...
  networking = {
    firewall.allowedTCPPorts = [ 8920 8096 443 80 ];
